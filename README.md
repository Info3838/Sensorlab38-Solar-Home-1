...
Δόθηκε έμφαση στον τελικό στόχο της κατασκευής και αυτό βοήθησε την ομάδα να μείνει εστιασμένη στο στόχο της.   
